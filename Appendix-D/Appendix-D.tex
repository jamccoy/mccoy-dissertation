...
As a next step toward describing a diffraction grating, the \emph{far-field approximation} is invoked, where the distance to $P_0$ is taken to be very large compared to the spacing between the slits so that $L \gg d$ and rays $\overrightarrow{S_1 P_0}$ and $\overrightarrow{S_2 P_0}$ are approximately parallel to each other. 
\begin{figure}
\centering
...
Given by \cref{eq:fringes}, there are five of these fringes corresponding to a value of $\vartheta_{\text{max}}$ where $n = 0, \pm 1, \pm 2$. 
...
\begin{equation}
 ...
 \end{equation}
which will be down to cause \emph{off-plane} diffraction [\emph{cf.\@} \cref{sec:grating_boundary}]. 
...
\begin{equation}\label{eq:sin_amplitude_grating_inten}
 ...
 \end{equation}
\end{subequations}
Although \cref{eq:sin_amplitude_grating} does not describe a physical grating in a general sense, this framework is useful to describe gratings where only one propagating order exists. 
...
\begin{figure}
 ...
 \caption[Relative efficiency of a sawtooth phase grating.]{Relative efficiency of a sawtooth phase grating at in a Littrow configuration with $\alpha = \delta = 30^{\circ}$.}\label{fig:sawtooth_phase} 
 \end{figure} 
...
\begin{figure}
 ...
 \caption[Relative efficiency of a sawtooth phase grating at the blaze wavelength in second order.]{Relative efficiency of a sawtooth phase grating at in a Littrow configuration with $\alpha = \delta = 30^{\circ}$, at the blaze wavelength for $n=2$.}\label{fig:sawtooth_phase_blaze} 
 \end{figure} 
