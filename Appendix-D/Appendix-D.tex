...
That is, the diffracted wave vector has an $x$-component $k'_{x,n} \equiv k \sin \left( \beta_n \right)$ equal to an integer number of grating wave numbers: %vectors: %edit
...
In this case, the diffraction pattern can be described two-dimensionally such that the incident ray is \emph{in-plane} with the orientations of all diffracted orders. %fringes. %edit
