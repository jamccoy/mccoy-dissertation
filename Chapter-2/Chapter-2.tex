...
\begin{equation}\label{eq:diffraction_efficiency}
 \mathscr{E}_n \! \left( \lambda \right)  \equiv \frac{\mathcal{I}_n \! \left( \lambda \right)}{\mathcal{I}_{\text{inc}} \! \left( \lambda \right)} \quad \text{for } n = 0, \pm 1, \pm 2, \pm 3 ..., 
 \end{equation} 
...
In analogy to a perfectly conducting mirror flat where $\mathcal{R}_F = 1$, however, the sum of $\mathscr{E}_n$ over all propagating orders is equal to unity. 
