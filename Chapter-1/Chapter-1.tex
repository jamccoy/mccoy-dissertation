...
%Hydrogen and helium are virtually the only elements whose nuclei were produced in the early Universe during \emph{primordial nucleosynthesis} and are by far the most abundant elements in the cosmos, making up $\sim \SI{74}{\percent}$ and $\sim \SI{24}{\percent}$ of all baryonic matter, respectively \cite{Mo10,Liddle03,Schneider06}, which in turn comprises $\gtrapprox \SI{4}{\percent}$ of the total mass-energy content according to measurements of acoustic oscillations observed in the \emph{cosmic microwave background} and primordial abundance ratios \cite{Kirkman03,Komatsu09,Planck_collab}. 
%The remaining $\sim \SI{2}{\percent}$ of baryonic matter is dominated by elements with higher $\mathcal{Z}$ (known as \emph{metals} in astronomy) that are generated during the life cycles of stars with more than about eight times the mass of the Sun with $M_{\odot} \approx \SI{2e30}{\kilogram}$ \cite{Hoyle46,Rolfs88,Carroll07,Ryden10}. 
%That is, while measurements of elemental abundance ratios from primordial nucleosynthesis and acoustic oscillations observed in the \emph{cosmic microwave background} indicate that baryons constitute $\gtrapprox \SI{4}{\percent}$ of the total mass-energy contained in the present-day Universe \cite{Kirkman03,Komatsu09,Planck_collab}, \SIrange{30}{40}{\percent} of this material is thought to reside in diffuse plasmas with characteristic temperatures intermediate between cool, neutral hydrogen gas and hot, x-ray-emitting intracluster media. 
%The regions in between star systems in a typical star-forming galaxy (the \emph{interstellar medium}) are enriched with atomic nuclei of low-to-mid $\mathcal{Z}$, such as oxygen, carbon and neon, predominately by supernovae that result from the deaths of these massive stars. %In a typical quiescent galaxy, the regions in between star systems (the \emph{interstellar medium}) are enriched with atomic nuclei of low-to-mid $\mathcal{Z}$, such as oxygen, carbon and neon, predominately by supernovae that result from the deaths of these massive stars. 
...
An \emph{active galaxy} is thought to be a phase of galactic evolution where copious amounts of gas and stellar material are accreting onto the central supermassive black hole while moreover, material outflows associated with the accretion also populate the circumgalactic medium, the intragroup or intracluster medium, and the intergalactic medium with metals \cite{Ishibashi16,Moll07,Zhang2018Galax}. %$\mathcal{Z} \geq 6$ baryons
%These regions associated with extended galactic halos, and additionally, the vast regions in between galaxies (the \emph{intergalactic medium}), are also populated with $\mathcal{Z} \geq 6$ baryons through outflows powered by supernovae and stellar winds in typical star-forming galaxies; 
In any case, material expelled from galaxies can exist for long time periods as an extremely diffuse plasma while portions of it eventually coalesce with interstellar media, where it ultimately contributes to star formation and galactic evolution \cite{Zhang2018Galax,angles-alcazar17,Tumlinson17}. %, highly-ionized  %eventually fall back into the interstellar medium of the host galaxy, where it ultimately contributes to star formation and evolution of the galaxy as a whole
\begin{figure}
 \centering
 \includegraphics[scale=2.25]{Chapter-1/Figures/CGM_Tumlinson.png}
...
%As shown in the figure, the active galaxy expels material from its nucleus through outflows while the circumgalactic and intergalactic media feed accretion back to the galactic disk. 

%Soft x-ray spectroscopy fits into this picture of the \emph{cosmic baryon cycle} with its exclusive ability to diagnose highly-ionized portions of circumgalactic and intergalactic media that are expected to constitute a significant fraction of the total baryon content in the Universe \cite{Bregman07,Nicastro18,Fukugita_2004}. 

%Studies of ratios in primordial nucleosynthesis and the cosmic microwave background indicate that baryons constitute
Soft x-ray spectroscopy fits into this picture of the \emph{cosmic baryon cycle} with its exclusive ability to diagnose highly-ionized portions of diffuse plasmas that are expected to constitute a significant fraction of the total baryon content in the Universe \cite{Persic92,Bregman07,McGaugh10}. % but are difficult to observe directly \cite{Shull05,Bregman07,Nicastro18,deGraaff19}. %highly-ionized portions of circumgalactic and intergalactic media
...
Approximately half of this material that exists outside of isolated galaxies, groups and clusters is expected to comprise the \emph{warm-hot intergalactic medium}, where filamentary structures of the \emph{cosmic web} are heated to \SIrange{e5}{e7}{\kelvin} by collisionless shocks induced by galactic feedback and gravitational effects of large-scale structure formation \cite{Cen99,Dave01,Nicastro05b,Nicastro08,Bykov08,deGraaff19}. %with modest overdensity (up to $\sim 10$ particles \si{\per\metre\cubed}) %with characteristic temperatures ranging from
%\SIrange{30}{40}{\percent} of this material is thought to reside in diffuse plasmas of circumgalactic media and additionally, shock-heated filamentary structures produced by matter overdensity between galaxy clusters 
%with characteristic temperatures intermediate between cool, neutral hydrogen gas and hot, x-ray-emitting intracluster media. 
%, which include the \emph{warm-hot intergalactic medium},
%Importantly, these plasmas contain abundant $\mathcal{Z} \geq 6$ elements as highly-charged ions that produce soft x-ray spectral lines while hydrogen and helium may be completely stripped of their electrons, rendering them invisible from the standpoint of spectroscopy at longer wavelengths. 
%However, the extremely low density of these plasmas (down to $\sim 1$ particle \si{\per\metre\cubed}) can make their spectroscopic detection difficult and often times prohibitive due to instrumental limitations, especially for emission spectroscopy. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-------------------------------------------------- 
%Soft X-ray Spectroscopy of Highly-Charged Ions in Circumgalactic and Intergalactic Media %circumgalactic and intergalactic media 
...
\begin{figure}
 ...
 \caption[Reflection grating geometry for conical diffraction.]{Reflection grating geometry for conical diffraction. In an extreme off-plane mount, the incoming radiation is nearly parallel to the groove direction where the half-angle of the cone opening, $\gamma$, is on the order of a degree and because of this, the angle on the groove facets, $\zeta$, is a grazing-incidence angle for any value of $\alpha$ that illuminates the shallow side of the sawtooth profile with a blaze angle $\delta$. At a distance $L$ away from the point of incidence on the grating, diffracted orders are each separated by a distance $\lambda L / d$ along the direction of grating periodicity (\emph{i.e.}, the grating-dispersion direction), where $d$ is the groove spacing.}\label{fig:conical_reflection_edit}
 \end{figure} 
...
\begin{equation}\label{eq:in-plane_orders_ch1}
 \sin \left( \alpha \right) + \sin \left( \beta \right) = \frac{n \lambda}{d} \quad \text{for } n = 0, \pm 1, \pm 2, \pm 3 ... 
 \end{equation}
...
\begin{equation}\label{eq:inplane_limit}
 2 \delta \left( \frac{\pi}{2} - \alpha \right) \approx \frac{n \lambda}{d} \quad \text{for } n = 0, \pm 1, \pm 2, \pm 3 ... 
 \end{equation}
\end{subequations}
...
\begin{equation}\label{eq:offplane_limit}
 2 \gamma \sin \left( \delta \right) \approx \frac{n \lambda}{d} \quad \text{for } n = 0, \pm 1, \pm 2, \pm 3 ... 
 \end{equation}
...
\begin{figure}
 ...
 \caption[The \textsc{EBPG5200} electron-beam lithography (EBL) system installed at the Penn State Nanofabrication Laboratory]{The \textsc{EBPG5200} electron-beam lithography system installed at the Penn State Nanofabrication Laboratory}\label{fig:ebeam_tool_pic}
 \end{figure}
...
\begin{equation}\label{eq:weight_avg_molecular_weight}
 ...
 \end{equation}
\end{subequations}
and this quantity is related to $M_n$ through the \emph{dispersity} of the material defined as $\DJ \equiv M_w / M_n \geq 1$, which is a measure of the polymer chain length distribution in the resist with $\text{PDI} = 1$ corresponding to a uniform distribution \cite{Stepto09,Kirchner19}. 
...
%much lower in $\langle 111 \rangle$ directions than all other crystallographic directions \cite{Franssila10,Gosalvez15}. 
%defined by exposed $\{ 111 \}$ planes appearing similar to a triangular sawtooth when viewed edge-on. 
...
%Owing to the cubic symmetry of this crystal structure, 
...
\begin{figure}
 ...
 \caption[Face-centered cubic structure of silicon (credit: T.\ Wood using \textsc{CrystalMaker})]{Three views of the face-centered cubic structure of silicon where $a_{\text{Si}} \approx \SI{0.54}{\nm}$ is the lattice constant, cube faces are $\{ 100 \}$ planes, purple spheres represent silicon atoms and gray bars indicate covalent bonds while a $(111)$ plane is shown in green: a) down the $[ 111 ]$ axis of a single unit cell, b) down the $[ 010 ]$ axis of a single unit cell and c) two adjacent cells. Image credit: T.\ Wood using \textsc{CrystalMaker X}.}\label{fig:crystal_structure} 
 \end{figure}
...
%However, the temperature of the solution, which strongly affects the etch rate, and the etch duration must be controlled carefully so that the groove structures are not over-etched and destroyed. 

%After this crucial step, the \ce{Si3N4} mask can be stripped away using \ce{HF} to leave the \ce{KOH}-etched structure in silicon. 
%An example of a grating fabricated in this way with $d \lessapprox \SI{160}{\nm}$ and a $\langle 311 \rangle$ wafer orientation is shown under field-emission scanning electron microscopy (FESEM) in \cref{fig:master_grating_SEM}. 

%Using $\langle h k \ell \rangle$ to denote crystallographic directions where $h$, $k$ and $\ell$ are \emph{Miller indices}\footnote{In this notation, $(h k \ell)$ indicates the set of crystallographic planes orthogonal to direction in the lattice direction denoted by $[ h k \ell ]$, which effectively represents a 3D vector without a normalization factor. Moreover, $\{ h k \ell \}$ indicates any crystallographic plane equivalent to $(h k \ell)$ by symmetry while $\langle h k \ell \rangle$ correspondingly represents any crystallographic direction equivalent to $[ h k \ell ]$ by symmetry. Note that an overbar on $h$, $k$ or $\ell$ indicates a negative Miller index.} that represent a basis of reciprocal lattice vectors, the \emph{face-centered cubic} 
%, where the distance between parallel $\{ 100 \}$ planes is given by the lattice constant, $a_{\text{Si}} \approx \SI{0.54}{\nm}$ \cite{Franssila10}. 


%As a result of the anisotropy associated with \ce{KOH} etching, where etch rates in a silicon crystal are much lower in $\langle 1 1 1 \rangle$ directions than all other families of crystallographic directions, the $\{ 1 1 1 \}$ planes that intersect with the edges of the defined etch-mask layout
...
%edges of the etch mask [\emph{e.g.}, \ce{Si_{x}N_{y}}; \emph{cf.\@} footnote~\ref{footnote:nitride_mask}] 
%such as $\langle 1 0 0 \rangle$ \cite{Franssila10,Gosalvez15}. 
%The etch can then be continued further to undercut beneath the \ce{Si_{x}N_{y}} mask so as to minimize the width of the groove flat-tops \cite{Franke97,McEntaffer13}. 
%Before discussing the details of these nanofabrication processes, various wafer geometries and their resulting blaze angles, $\delta$, are considered in the following paragraphs. 
...
\begin{figure}
 ...
 \caption[Field-emission scanning electron micrograph (FESEM) of a \ce{KOH}-etched grating viewed edge-on.]{Field emission scanning electron micrograph (FESEM) of a \ce{KOH}-etched grating with $d \lessapprox \SI{160}{\nm}$ viewed edge-on, taken with a \textsc{Zeiss Leo 1530} instrument at the Penn State Nanofabrication Laboratory. Due to the $\langle 311 \rangle$ surface orientation of the silicon wafer used for processing, the etched sawtooth structure nominally features an active blaze angle of $\delta = 29.5^{\circ}$ and a steep-facet angle of $\bar{\delta} =  79.98^{\circ}$ [\emph{cf.\@} \cref{eq:311_angle,eq:311_angle2}]. Flat tops that protrude above the sawtooth pattern exist as a result of the \ce{Si_{x}N_{y}} etch mask [\emph{cf.\@} \cref{fig:master_fab}] while the groove depth follows from \cref{eq:groove_depth}.}\label{fig:master_grating_SEM}
 \end{figure}
...
\begin{equation}\label{eq:groove_depth}
 ...
 \end{equation}
where $\Delta h$ is the vertical protrusion of the top plateau. 
...
In an etched $\langle 311 \rangle$-oriented wafer, for example, the distance between $\{ 111 \}$ planes, $d_{111} \equiv a_{\text{Si}}/\sqrt{3}$, projects to a lateral spacing on the surface of the wafer of 
\begin{equation}
...
\begin{figure} 
 ...
 \caption[Outline of a grating replication process that uses a \ce{KOH}-etched master grating to imprint to ultraviolet-curable resist by UV-NIL.]{Outline of a grating replication process that used UV-NIL to imprint a \ce{KOH}-etched master grating into UV-curable resist.}\label{fig:uv_nil} 
 \end{figure}
...
\begin{figure} 
 ...
 \caption[AFM of a blazed grating fabricated by UV-NIL from a \ce{KOH}-etched master (credit: T.\ Tighe)]{AFM of a blazed grating fabricated by UV-NIL from a \ce{KOH}-etched master. Image credit: T.\ Tighe at the Penn State MCL.}\label{fig:uv_nil_AFM} 
 \end{figure}
